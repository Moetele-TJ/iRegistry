  ...
  const items = useMemo(
    () => [
      ...
      { to: "/admindashboard/transactions", icon: <ReceiptText size={20} />, label: "Transactions" },
      {
        ...
        label: "Items",
        subItems: [
          { to: "/admindashboard/items", label: "Active Items", end: true },
          { to: "/admindashboard/items/deleted", label: "Deleted Items", end: true },
          { to: "/admindashboard/items/legacy", label: "Legacy items", end: true },
        ],
      },
