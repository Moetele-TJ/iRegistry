  ...
  return (
    <div className="max-w-5xl mx-auto w-full">
      <PageSectionCard
        ...
        subtitle="Counts each time an SMS code is actually sent after credits are debited (audit: OTP_SENT, channel sms). Provider failures after debit are listed separately."
      ...
      >
        <div className="p-4 sm:p-6 space-y-6">
          ...
          <div>
            <h2 className="text-sm font-semibold text-gray-800 mb-2">By day (UTC)</h2>
            {loading ? (
              <div className="text-sm text-gray-500 py-6">Loading…</div>
            ) : byDay.length === 0 ? (
              <div className="text-sm text-gray-500 py-6">No data in this range.</div>
            ) : (
