    ...
    <div className="max-w-2xl mx-auto p-4 sm:p-6 space-y-4">
      <div>
        ...
        <p className="text-sm text-gray-600 mt-1">
          First two registrations are free; then packs of 10 cost 5 credits. Clear photos are required for
          matching.
        </p>
      </div>

      <form onSubmit={(e) => void onSubmit(e)} className="space-y-4 rounded-2xl border border-gray-100 bg-white p-4">
