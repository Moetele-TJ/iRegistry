-- -----------------------------------------------------------------------------
-- Public registry stats: add top stolen by village/town
--
-- Adds:
-- - topStolenVillages: top 5 villages/towns where stolen items are registered
--   (based on items.village; falls back to 'Unknown' when missing)
-- -----------------------------------------------------------------------------
